...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-72 flex-col border-r border-slate-200 bg-white px-5 py-6 transition-transform duration-300 dark:border-slate-800 dark:bg-[#081223] lg:z-20 ${
      ...
      >
        <div className="mb-8 flex items-start justify-between">
          ...
          <button
            type="button"
            onClick={onClose}
            className="inline-flex h-10 w-10 items-center justify-center rounded-2xl text-slate-500 transition hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800 lg:hidden"
        ...
        <div className="mt-auto space-y-6">
          ...
          <div className="overflow-hidden rounded-3xl border border-emerald-100 bg-gradient-to-br from-emerald-50 to-cyan-50 p-5 dark:border-emerald-500/10 dark:from-emerald-500/10 dark:to-cyan-500/5">
            ...
            <div className="mt-5 h-20 rounded-2xl bg-gradient-to-r from-emerald-400/30 via-cyan-300/20 to-sky-300/20 dark:from-emerald-500/20 dark:via-cyan-500/10 dark:to-sky-500/10 sm:h-24" />
          </div>
        </div>
      </aside>
    </>
